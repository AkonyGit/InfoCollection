...
var strjson = {};
console.log(bdcTrace_request_url)
var href = document.location.href;
var bdcTrace_request_url;
if(href.indexOf('restdev')!=-1||href.indexOf('resttest')!=-1||href.indexOf('10.1.23.37')!=-1){
	bdcTrace_request_url = "http://bdcrestdev.hexun.com";
}else{
	bdcTrace_request_url = "https://trace.hexun.com";
}
